...
if __name__ == '__main__':
    ...
    slide_list = os.listdir(args.wsi_path) # get slide file names
    slide_list = [s for s in slide_list if s.endswith('.svs') or s.endswith('.tiff') or s.endswith(".png") or s.endswith('.tif')] # delete this png stuff when doing this on proper images
...
#python sequoia-codes/patch_gen_hdf5.py --wsi_path images/processed_coad_images --patch_path sequoia-outputs/patches --mask_path sequoia-outputs/masks --end 1 --max_patches_per_slide 4000 --parallel 1 --patch_size 256

#python sequoia-codes/patch_gen_hdf5.py --wsi_path images/lihc_images --patch_path sequoia-outputs/patches --mask_path sequoia-outputs/masks --end 1 --max_patches_per_slide 4000 --parallel 1 --patch_size 256

#python sequoia-codes/patch_gen_hdf5.py --wsi_path images/better_lihc_images --patch_path sequoia-outputs/patches --mask_path sequoia-outputs/masks --end 1 --max_patches_per_slide 4000 --parallel 1 --patch_size 256
#python sequoia-codes/patch_gen_hdf5.py --wsi_path images/coad_images --patch_path sequoia-outputs/patches/coad_multiple_images --mask_path sequoia-outputs/masks --start 0 --end 4 --max_patches_per_slide 4000 --parallel 1 --patch_size 256 --ref_file sequoia-outputs/ref_file_coad_multiple_images.csv