...
if __name__=='__main__':
    ...
    print('Done')
#python "C:\Users\taoyu\OneDrive\Documents\ASTAR\get_emd.py" --slide_nr --project spatial_coad_pred --wsi_file_name "C:\Users\taoyu\OneDrive\Documents\ASTAR\more_tcga\images\TCGA-A6-2671-01Z-00-DX1.13d1a0d9-78cd-4cfc-b670-34a79ebe52ee.svs" --gene_names KRAS,APC,MSH2 --save_folder visualisation --model_type vis --feat_type resnet
