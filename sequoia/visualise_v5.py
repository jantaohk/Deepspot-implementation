...
if __name__=='__main__':
    ...
    print('Done')
#python sequoia-codes/visualise_v5.py --study coad --project spatial_coad_pred --wsi_file_name images/coad_images/TCGA-4N-A93T-01Z-00-DX2.875E7F95-A6D4-4BEB-A331-F9D8080898C2.svs --gene_names ALB,CD68,EPCAM,CD3D,CD3E,CD3G,KRT19 --save_folder sequoia-outputs/uni_visualisation --model_type vis --feat_type uni --folds 0 --checkpoint sequoia-outputs/uni_results/TCGA_coad_multiple_images --patch_size 512 --stride 1 --mask sequoia-outputs/masks/TCGA_coad_multiple_images/TCGA-4N-A93T-01Z-00-DX2/mask.npy --save_name "4N-A93T 512.csv"
#python sequoia-codes/visualise_v5.py --study coad --project spatial_coad_pred --wsi_file_name images/coad_images/TCGA-4N-A93T-01Z-00-DX2.875E7F95-A6D4-4BEB-A331-F9D8080898C2.svs --gene_names BRAF --save_folder sequoia-outputs/uni_visualisation --model_type vis --feat_type uni --folds 0 --checkpoint sequoia-outputs/uni_results/TCGA_coad_multiple_images --patch_size 512 --stride 1 --mask sequoia-outputs/masks/TCGA_coad_multiple_images/TCGA-4N-A93T-01Z-00-DX2/mask.npy --save_name "4N-A93T 512 BRAF.csv"
...
#python sequoia-codes/visualise_v5.py --study coad --project spatial_coad_pred --wsi_file_name images/coad_images/TCGA-4T-AA8H-01Z-00-DX1.A46C759C-74A2-4724-B6B5-DECA0D16E029.svs --gene_names BRAF --save_folder sequoia-outputs/uni_visualisation --model_type vis --feat_type uni --folds 0 --checkpoint sequoia-outputs/uni_results/TCGA_coad_multiple_images --patch_size 512 --stride 1 --mask sequoia-outputs/masks/TCGA_coad_multiple_images/TCGA-4T-AA8H-01Z-00-DX1/mask.npy --save_name "4T-AA8H 512 BRAF.csv"
#python sequoia-codes/visualise_v5.py --study coad --project spatial_coad_pred --wsi_file_name images/coad_images/TCGA-5M-AAT4-01Z-00-DX1.725C46CA-9354-43AC-AA81-3E5A66354D6B.svs --gene_names BRAF,CD68,EPCAM,CD3D,CD3E,CD3G --save_folder sequoia-outputs/uni_visualisation --model_type vis --feat_type uni --folds 0 --checkpoint sequoia-outputs/uni_results/TCGA_coad_multiple_images --patch_size 512 --stride 1 --mask sequoia-outputs/masks/TCGA_coad_multiple_images/TCGA-5M-AAT4-01Z-00-DX1/mask.npy --save_name "5M-AAT4 512.csv"
#python sequoia-codes/visualise_v5.py --study coad --project spatial_coad_pred --wsi_file_name images/coad_images/TCGA-A6-2678-01Z-00-DX1.bded5c5c-555a-492a-91c7-151492d0ee5e.svs --gene_names BRAF,CD68,EPCAM,CD3D,CD3E,CD3G --save_folder sequoia-outputs/uni_visualisation --model_type vis --feat_type uni --folds 0 --checkpoint sequoia-outputs/uni_results/TCGA_coad_multiple_images --patch_size 512 --stride 1 --mask sequoia-outputs/masks/TCGA_coad_multiple_images/TCGA-A6-2678-01Z-00-DX1/mask.npy --save_name "A6-2678 512.csv"